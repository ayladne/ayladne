...
🎓 **Master's student in Applied Mathematics and Computer Science for Social Sciences** at Université Grenoble Alpes, passionate about software and web development.

## 🔍 About Me
- 💻 **Development**: Java, JavaScript, PHP, HTML, CSS, SQL, Shell
- 🚀 **Experience**: Web development with TypeScript, React, Vercel
- 🔬 **Scientific curiosity**: Cultural mediation and social science research
- 🎨 **Broad interests**: Artistic and creative projects, nanorobotics (hoping to specialize in it!), and building mini applications for anything and everything
